    ...
    def update_stimulus(self, fish_index, stimulus_index, stimulus_time, dt):
        ...
        if 0 <= stimulus_time % self.stimulus_time_per_subtrial < 5:  # 0-5 rest; 5-30 CL; 30-120 asymmetric gain
            ...
            if stimulus_index == 0:
                ...
                elif ((fish_ac > 0) & (self.decided[fish_index] == 0)) & ((self.time_after_start[fish_index] > 0.1) & (self.int_angle[fish_index]/self.frame_count_after_start[fish_index] > self.baseline_angle[fish_index])):
                    gain = fullgain*0.2
...
#            fish_speed = 300
        ...
        return [trial_num, trial_num_processed, stimulus_index, gain, forward_speed, fish_speed, self.pattern_offset[fish_index], dt, stimulus_time, stimname, curr_angle, curr_angle_mean, self.baseline_angle[fish_index], self.frame_count_after_start[fish_index], self.int_angle[fish_index]]
