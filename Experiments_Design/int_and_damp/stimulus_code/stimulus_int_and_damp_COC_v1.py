...
class MyApp(Panda3D_Scene):
    def __init__(self, shared):
        ...
        self.stimulus_time_per_stimulus = 620
        self.prev_ac = 0
    ...
    def update_stimulus(self, fish_index, stimulus_index, stimulus_time, dt):
        ...
        if 0 <= stimulus_time < 10:
            ...
            forward_speed = 0
            stimname = 0 # 'rest'
        elif 10 <= stimulus_time < 110: 
            gain = 0.1
            forward_speed = 0.1
            stimname = 1 # 'CL'
        elif 110 <= stimulus_time < 210:
            gain = 0
            forward_speed = 0.1
            stimname = 2 # 'OL'
            ...
            forward_speed = 0
            stimname = 0 # 'rest'
        elif 320 <= stimulus_time < 420: 
            gain = 0
            forward_speed = 0.1
            stimname = 2 # 'OL'
        elif 420 <= stimulus_time < 520:
            gain = 0.1
            forward_speed = 0.1
            stimname = 1 # 'CL'
        elif 520 <= stimulus_time < 620:
            gain = 0
            forward_speed = 0.1
            stimname = 2 # 'OL'
        else:
