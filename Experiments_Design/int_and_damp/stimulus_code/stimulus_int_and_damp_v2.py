...
class MyApp(Panda3D_Scene):
    def __init__(self, shared):
        ...
        self.stimulus_time_per_stimulus = 1620
        self.prev_ac = 0
    ...
    def update_stimulus(self, fish_index, stimulus_index, stimulus_time, dt):
        ...
        if 0 <= stimulus_time < 10:
            ...
            forward_speed = 0
            stimname = 0 # 'rest'
        elif 10 <= stimulus_time < 410: 
            gain = 0.1
            forward_speed = 0.1
            stimname = 1 # 'CL'
        elif 410 <= stimulus_time < 810:
            gain = 0
            forward_speed = 0.1
            stimname = 2 # 'OL'
        elif 810 <= stimulus_time < 820:
            gain = 0.1
            forward_speed = 0
            stimname = 0 # 'rest'
        elif 820 <= stimulus_time < 1220: 
            gain = 0.1
            forward_speed = 0.1
            stimname = 1 # 'CL'
        elif 1220 <= stimulus_time < 1620:
            gain = 0
            forward_speed = 0.1
            stimname = 2 # 'OL'
        else:
